...
**[Download the presentation slides (PDF)](/Fractal%20Partitioning%20Theory.pdf)** — the slides walk through the theory with the same CS-oriented framing: state-spaces as arrays, partitions as clustering, tension as edge weights, and the self-model as a fixed-point recursion.

The full working paper (*FPT: A Computer Scientist's Guide to a Theory of Consciousness*) is available as a [downloadable document](/FPT_CS_Edition.docx) for readers who want the complete pseudocode, formal definitions, and the full AI taxonomy.
